# Tecnicas para planteamiento de problemas y aplicación a la ida de proyectos de investigación
...
Presentación que incluya para 3 técnicas:
...
R/ Un árbol de problemas es una herramienta visual utilizada para identificar y analizar las causas y efectos de un problema específico. Se representa como un diagrama en forma de árbol, donde el problema central se coloca en el tronco, las causas se ubican en las raices y en la parte superior se colocan los efectos o consecuencias del problema. Esta técnica ayuda a descomponer un problema complejo en partes más manejables, facilitando la identificación de soluciones efectivas.
...
👉 En este caso: es ideal porque se esta estructurando el trabajo de grado.
